...
-- Dumping data for table test.migrations: ~3 rows (approximately)
...
REPLACE INTO `users` (`id`, `name`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, NULL, 'coba@gmail.com', NULL, '$2y$10$X6EZz1yTRzOilrXdkekpLesMfLgw92SFpC9tEMeKufZrz.dMpkTdq', NULL, '2021-02-02 02:45:18', '2021-02-02 02:45:18');
